...
\clearpage
\thispagestyle{plain}
\par\vspace*{.35\textheight}{\centering \Large{\paragraph{Dedicated} \textit{to my parents: Henry \& Florence Dohmatob.} \\
    \textit{And to my brothers and sisters: Valy, Kah, \& Kingsly.}}\par}
