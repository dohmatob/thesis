...
% Pour la validation des m\'ethodes que nous allons d\'evelopper, nous allons les benchmarker sur divers r\'eels des jeux de donn\'es.
% Ces m\'ethodes seront publier dans des journaux et conf\'erences sp\'ecialis\'es.

\clearpage
\thispagestyle{plain}
\par\vspace*{.35\textheight}{\centering \Large{\paragraph{Dedicated} \textit{to my parents: Florence \& Henry Dohmatob.} \\
    \textit{And to my sister and brothers: Kah, Kingsly, Valy.}}\\ --\textit{The most wonderful people I know!}--\par}
...
% This is especially true for the open-spacers, for putting up with the noise I usually make in the open space...
