...
\clearpage
\thispagestyle{plain}
\par\vspace*{.35\textheight}{\centering \Large{\paragraph{Dedicated} to my parents: \textit{Henry \& Florence Dohmatob.} \\ And to my brothers and sisters: \textit{Valy, Kah, \& Kingsly.}}\par}
\chapter*{Acknowledgements}
Many thanks to my supervisors Bertrand Thirion and Gael Varoquaux for
% introducing me to the world of neuro-imaging and the neurosciences and for
their constant help and support during these 3 years preparing my PhD project.
Special thanks to the team assistants Regine Bricquet and Tiffany Caristan for their generous help with administrative matters.
I would also want to thank the rest of the Parietal team --past and present-- for ensuring such a nice work environment. This is especially true for the open-spacers, for putting up with the noise I usually make in the open space...
