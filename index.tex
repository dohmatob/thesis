...
{\LARGE A dissertation submitted in partial fulfillement \\ \vspace{10pt} of the requirements for the degree of Doctor of Philosophy, \\ \vspace{10pt} specialized in Computer Science.} \\
\vspace{1pc}
...
\begin{tabular}{lll}
\vspace{1pc}
\textbf{Advisors} & Bertrand Thirion & Parietal Team, INRIA / CEA, France \\
\vspace{1pc}
 & Gael Varoquaux & Parietal Team, INRIA / CEA, France \\
\vspace{1pc}
  \textbf{Reviewers} & John Ashburner  & University College London, UK  \\
  \vspace{1pc}  
& Gabriel Peyr\'e  & CERAMADE, Universit\'e Paris Dolphine, France  \\  \\
  \vspace{1pc}
\textbf{Examiners} & Olivier Fercoq & Telecom ParisTech, France \\
\vspace{1pc}
\end{tabular}
}
...
\begin{tabular}{lll}
\vspace{1pc}
\textbf{Directeurs} & Bertrand Thirion & Parietal Team, INRIA / CEA, France \\
\vspace{1pc}
 & Gael Varoquaux & Parietal Team, INRIA / CEA, France \\
\vspace{1pc}
  \textbf{Rapporteurs} & John Ashburner  & University College London, UK  \\
  \vspace{1pc}  
& Gabriel Peyr\'e  & CERAMADE, Universit\'e Paris Dolphine, France  \\  \\
  \vspace{1pc}
\textbf{Examinateurs} & Olivier Fercoq & Telecom ParisTech, France \\
\vspace{1pc}
\end{tabular}
}
...
% $\text{tr}(\B{X})$ & Trace of a matrix & $\sum_{i} a_{ii}$ \\  
...
%   $\text{Lap}(\B{v})$ & Laplacian regularization of a 3D image $\B{v}$ & $\frac{1}{2}\sum_{k=1}^p(\nabla_x \B{v})_k^2 + (\nabla_y \B{v})_k^2 + (\nabla_z \B{v})_k^2$ \\ % = \frac{1}{2}{\B{v}}^T\Delta \B{v} \ge 0$
%   $\|\B{v}\|_{\text{TV}}$ & Total-Variation (isotropic) regularization & $\sum_{k=1}^p\sqrt{(\nabla_x \B{v})_k^2 + (\nabla_y \B{v})_k^2 + (\nabla_z \B{v})_k^2}$\\
% \bottomrule
% \end{tabular}
% \end{fullwidth}
% \vspace*{\fill}
