...
\begin{itemize}
  ...
  \item \textit{What are the neuro-biological markers of neurological os psychiatric mental illness ?}
...
\textbf{XXX What about Chapter 6 ?}
...
% , with a focus on the localization of task-based brain activity.
  Section \ref{sec:rsfmri} will present the another way of probing brain function,
...
%
MRI imaging can be used to measure this effect, called the BOLD (\textit{Blood Oxygen-Level-Dependent}) signal~\citep{agawa1990,ogawa1990b}, at a spatial typically resolution of 1.5 to 3mm, and a temporal resolution
