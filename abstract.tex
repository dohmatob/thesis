...
\begin{itemize}
\item \textbf{Part I:} General introduction $\implies$ chapter \ref{chap:intro}.
\item \textbf{Part II:} General preliminaries on neurosciences and neuro-imaging, main motivations for this PhD project, current statistical methods for analyzing brain data $\implies$ chapter \ref{chap:bigpic}.
\item \textbf{Part III:} Structured penalties for brain decoding $\implies$ chapters \ref{chap:structured_priors}, \ref{chap:efficient_opt}, \ref{chap:speeding}, \ref{chap:igraphnet}, \ref{chap:admm}.
\item \textbf{Part III:} Structured generative models for brain data $\implies$ chapters \ref{chap:func_var}, \ref{chap:proxdict}.
\item \textbf{Conclusion:} New schemes for direct registration of functional brain data $\implies$ chapter \ref{chap:epi2epi}, \ref{chap:rsfmri2tfmri}.
\end{itemize}
