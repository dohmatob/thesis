...
% , with a focus on the localization of task-based brain activity.
  Section \ref{sec:rsfmri} will present another way of infering brain function,
...
When a brain area is solicited, it brain fires chemical signals to provide it
...
A run contains usually from 100 to 1000 scans. fMRI scans are
acquired slice-by-slice, usually in the axial direction. The time required to acquire
