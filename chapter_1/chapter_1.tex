...
%
% Indeed, as noted in \cite{pmid25405472}, subject motion 
%and eddy current 
...
the methods described in \cite{VanEssen20122222}. %% In particular, we replace the costly
%% BBR \cite{greve2009accurate}
...
%% This model is triggered in ANTs \cite{avants2008,avants2011} using the following command-line options:
%% \begin{verbatim}
...
%% \begin{itemize}
%% \item EPI to structural registration \cite{greve2009accurate}. See Fig. \ref{fig:bbr}.
%%   \begin{itemize}
...
% that are interesting in functional connectomics
...
%%   \cite{abraham2014machine} implementation of CanICA\cite{varoquaux2010group,varoquaux2010ica} after inter-subject registration, on multi-subject functional data
%%   registered using the different pipelines. We see that the geometry of the patterns are essentially the same across the different pipelines. The Default Mode Network \cite{raichle2001} has been labeled pink; a more detailed view of this network is presented in Figure \ref{fig:dmn} of the supplementary materials section.}
%%   \label{fig:atlas}
%% \end{figure}
...
\includegraphics[width=.24\linewidth]{figures/DC+T1_Leftlateralparietal.png}
\includegraphics[width=.24\linewidth]{figures/DC+SBRef_Leftlateralparietal.png}
%% \includegraphics[width=.24\linewidth]{figures/DC+T1_Rightlateralparietal.png}
%% \includegraphics[width=.24\linewidth]{figures/DC+SBRef_Rightlateralparietal.png}
...
\begin{figure*}[!htbp]
%% \includegraphics[width=.235\linewidth]{figures/0BK-2BK_DC+T1.png}
%% \includegraphics[width=.235\linewidth]{figures/0BK-2BK_DC+SBRef.png}
\includegraphics[width=.235\linewidth]{figures/MATH-STORY_DC+T1.png}
\includegraphics[width=.235\linewidth]{figures/MATH-STORY_DC+SBRef.png}
\includegraphics[width=.235\linewidth]{figures/LH-RH_DC+T1.png}
\includegraphics[width=.235\linewidth]{figures/LH-RH_DC+SBRef.png}

\includegraphics[width=.48\linewidth]{figures/MATH-STORY_blobs.png}
\includegraphics[width=.48\linewidth]{figures/LH-RH_blobs.png}

\includegraphics[width=.235\linewidth]{figures/FACES-SHAPES_DC+T1.png}
\includegraphics[width=.235\linewidth]{figures/FACES-SHAPES_DC+SBRef.png}
%% \includegraphics[width=.235\linewidth]{figures/REL-MATCH_DC+T1.png}
%% \includegraphics[width=.235\linewidth]{figures/REL-MATCH_DC+SBRef.png}
\includegraphics[width=.235\linewidth]{figures/LF-RF_DC+T1.png}
\includegraphics[width=.235\linewidth]{figures/LF-RF_DC+SBRef.png}
...
%% \includegraphics[width=.235\linewidth]{figures/FACE-AVG_DC+T1.png}
%% \includegraphics[width=.235\linewidth]{figures/FACE-AVG_DC+SBRef.png}
%% \includegraphics[width=.235\linewidth]{figures/BODY-AVG_DC+T1.png}
%% \includegraphics[width=.235\linewidth]{figures/BODY-AVG_DC+SBRef.png}
...
%% \includegraphics[width=.235\linewidth]{figures/REWARD-PUNISH_DC+T1.png}
%% \includegraphics[width=.235\linewidth]{figures/REWARD-PUNISH_DC+SBRef.png}
%% \includegraphics[width=.235\linewidth]{figures/TOOL-AVG_DC+T1.png}
%% \includegraphics[width=.235\linewidth]{figures/TOOL-AVG_DC+SBRef.png}
...
%% destroyed in \cite{p}. They indeed tested
