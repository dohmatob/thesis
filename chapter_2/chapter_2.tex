...
\subsection{Comparing SpaceNet with against basic models}
...
which are applicable whenever a procedure for obtaining (an unbiased estimate) of the number of degrees of freedom of the model is available. Recently, ~\citep{sugar} has proposed a STEIN-based technique for structured models with many hyper-parameters.
