...
\begin{pagefigure}%[!htbp]
  ...
  \caption{\textbf{Top:} $R^2$-score for predicting subject-specific activation maps from resting
    data. These results are for the different contrasts of the HCP dataset~\citep{VanEssen20122222} are shown.
