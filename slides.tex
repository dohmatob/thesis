...
\only<2->{
  ...
  \hspace{-2.3em}\mydot Such a model is much more \emph{intepretable} (i.e small number of \emph{regions}) than classical methods like SVM, Ridge regression, Lasso
...
\begin{frame}
  ...
  \begin{beamerboxesrounded}{\emph{Faster, better, stronger!}}
    We propose a combination of algorithmic and implementation improvements which make these models usable in practice
    out-of-the-box
...
\begin{frame}% \Large
  ...
  \uncover<3->{
    ...
    for \emph{structured penalized multi-variate models} for brain decoding and region-extraction % (TV-L1, GraphNet, etc.)
...
\begin{frame}
  \frametitle{Concluding remarks}
  \begin{beamerboxesrounded}{\emph{Structured dictionary-learning}}
